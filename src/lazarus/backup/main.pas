...
const
  ...
  PluginNameANSI = #$45#$78#$65#$64#$69#$74#$20#$52#$41#$4d#$20#$50#$72#$65#$76#$69#$65#$77;
  PluginInfoANSI = PluginNameANSI + ' ' + Version;
  PluginNameAudioANSI = #$45#$78#$65#$64#$69#$74#$20#$52#$41#$4d#$20#$50#$72#$65#$76#$69#$65#$77#$28#$41#$75#$64#$69#$6f#$29;
...
const
  OutputFilter = #$44#$4f#$20#$4e#$4f#$54#$20#$55#$53#$45#$20#$54#$48#$49#$53#$20#$54#$4f#$20#$45#$58#$50#$4f#$52#$54#$21#$21#$21;
  BoolConv: array[boolean] of AviUtlBool = (AVIUTL_FALSE, AVIUTL_TRUE);
  ScaleMap: array[0..3] of integer = (1, 1, 2, 4);
  CaptureButtonCaption = 'Create cache from selected';
  AbortButtonCaption = 'Press ESC key to cancel';
...
const
  ClearCacheCaption = #$43#$6c#$65#$61#$72#$20#$63#$61#$63#$68#$65;
  // Clear cache
begin
  Result := AVIUTL_TRUE;
...
const
  ...
  ToggleModeCaption = #$53#$77#$69#$74#$63#$68#$20#$63#$61#$63#$68#$69#$6e#$67#$20#$6d#$6f#$64#$65#$20#$28#$4e#$6f#$72#$6d#$61#$6c#$20#$2f#$20#$52#$41#$4d#$20#$50#$72#$65#$76#$69#$65#$77#$29;
  // Switch caching mode (Normal / RAM Preview)
  CaptureCaption = #$43#$72#$65#$61#$74#$65#$20#$63#$61#$63#$68#$65#$20#$66#$72#$6f#$6d#$20#$73#$65#$6c#$65#$63#$74#$65#$64;
  // Create cache from selected
  ClearCacheCaption = #$43#$6c#$65#$61#$72#$20#$63#$61#$63#$68#$65;
  // Clear cache
var
  Y, Height: integer;
  ...
  case Message of
    ...
    begin
      ...
      SendMessageW(FResolutionComboBox, CB_ADDSTRING, 0,
        {%H-}LPARAM(PWideChar('Uncompresed')));
      SendMessageW(FResolutionComboBox, CB_ADDSTRING, 0,
        {%H-}LPARAM(PWideChar('Standard'))); // 1/4
      SendMessageW(FResolutionComboBox, CB_ADDSTRING, 0,
        {%H-}LPARAM(PWideChar('1/2 of Resolution'))); // 1/16
      SendMessageW(FResolutionComboBox, CB_ADDSTRING, 0,
        {%H-}LPARAM(PWideChar('1/4 of Resolution'))); // 1/64
      ...
      try
        ...
        if si.wProcessorArchitecture <> PROCESSOR_ARCHITECTURE_AMD64 then
          raise Exception.Create(PluginName +
            'You need a 64-bit version of Windows to use this.');
        if sinfo.Build < 10000 then
          raise Exception.Create(PluginName +
            'AviUtl version 1.00 or later is required to use this plugin.');
        ...
        begin
          SetWindowTextW(Window,
            ...
            'Plugin unavailable (Initialization failure)')));
      ...
      try
        ...
        on E: Exception do
          MessageBoxW(FWindow, PWideChar(
            WideString('An error occurred during processing '#13#10#13#10 +
            WideString(E.Message))),
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        FErrorMessage := WideString(
          'An error occurred during processing.'#13#10#13#10 +
          E.Message);
  ...
  try
    ...
    on E: Exception do
      MessageBoxW(Filter^.Hwnd,
        PWideChar(WideString('An error occurred during initialization.'#13#10#13#10 + WideString(E.Message))), PluginName, MB_ICONERROR);
  end;
end;
